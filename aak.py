# -*- coding: utf-8 -*-
"""
Created on Tue Feb 20 23:37:28 2018
...
#  data
path = "./"
path1 = "./CNNGestureRecognizer"    #path of folder of images

## Path2 is the folder which is fed in to training model
path2 = './imgfolder_b'

WeightFileName = ["weights_gesture.hdf5","bw_4015imgs_weights.hdf5","bw_2510imgs_weights.hdf5","./bw_weight.hdf5","./final_c_weights.hdf5","./semiVgg_1_weights.hdf5","/new_wt_dropout20.hdf5","./weights-CNN-gesture_skinmask.hdf5"]
...
def trainModel(model):
    ...
    cp=ModelCheckpoint(filepath,monitor='acc',verbose=1,save_best_only=True,mode='max',period=3)
    # Now start the training of the loaded model
    hist = model.fit(X_train, Y_train, batch_size=batch_size, epochs=nb_epoch,
                 verbose=1, callbacks=[cp],validation_data=(X_test,Y_test))
